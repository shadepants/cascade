...
- Name: cascade.spec.ts >> spotlight is set on the faction the player gives to
- Location: tests\cascade.spec.ts:138:1
...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    128 × waiting for element to be visible, enabled and stable
        - element is visible, enabled and stable
        - scrolling into view if needed
        - done scrolling
        - element is outside of the viewport
...
- generic [ref=e4]:
  - generic [ref=e6]:
    ...
    - generic "Insight earned by narrative engagement" [ref=e10]: ✧ 349 Insight
  - generic [ref=e15]:
  ...
  - generic [ref=e20]:
    - generic [ref=e21]:
      - generic [ref=e22]: Ancestral Blade
      - button "Close action menu" [ref=e23] [cursor=pointer]: ✕
    - paragraph [ref=e24]: A rusted sword that still hums with the memory of a hundred battles.
    ...
    - generic [ref=e26]:
      ...
      - button "Give to Thornhold Remnant" [ref=e38] [cursor=pointer]
      - button "Give to Ashvale Remnant" [ref=e39] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e40] [cursor=pointer]
      ...
      - button "Give to Thornhold Remnant" [ref=e44] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e45] [cursor=pointer]
      - button "Give to Ashvale Remnant" [ref=e46] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e47] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e48] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e49] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e50] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e51] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e52] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e53] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e54] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e55] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e56] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e57] [cursor=pointer]
      - button "Give to Thornhold Remnant" [ref=e58] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e59] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e60] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e61] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e62] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e63] [cursor=pointer]
      - button "Give to Duskmere Remnant" [ref=e64] [cursor=pointer]
    - paragraph [ref=e65]: Press Escape to cancel
```
